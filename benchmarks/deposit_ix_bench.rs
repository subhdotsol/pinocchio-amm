...
fn main() {
    ...
    // LP mint: supply = 0, mint_authority = config_pda (first deposit path)
    ...
    // Vault accounts at ATA addresses, empty (first deposit: lp_supply == 0)
